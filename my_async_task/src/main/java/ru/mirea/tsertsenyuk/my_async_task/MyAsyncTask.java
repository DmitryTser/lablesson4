package ru.mirea.tsertsenyuk.my_async_task;
...
public class MyAsyncTask extends AsyncTask<Void, Integer, Void> {
    ...
    protected void onPostExecute(Void result) {
        ...
        Long graduation = getDayEnd(strDate, "20.07.2021") * 24;
        String grad_str = graduation.toString();
        updateText("До получения диплома " + grad_str + " часов");
    }
